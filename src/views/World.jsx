          ...
          <div className="home-box">
            <div className="world-content">
              <div className="world-text-box">
                ...
                <p className="mob-p">
                  그러던 어느 날 왕수리부엉이는 발왕산의 <br />
                  제일 큰 나무에 둥지를 짓고 다섯 개의 알을 낳았어요.
                  <br /> <br />
                  왕수리부엉이는 태어날 다섯 마리 수리부엉이가 <br />
                  세상을 크게 이롭게 하라는 뜻으로 <br />
                  오빌리 <img src={Chap2Img} alt="" /> 라 <br />
                  이름을 지어주었어요.
                  <br /> <br />
                  왕수리부엉이의 따뜻한 보살핌 속에 오빌리들은 <br />
                  무사히 태어났고 행복한 나날을 보냈어요.
                </p>
              </div>
            </div>
            ...
            <div className="world-content">
              <div className="world-text-box">
                ...
                <p className="mob-p">
                  ...
                  여행과 레포츠의 즐거움을 알려주고
                  <br />
                  교양과 봉사의 마음도 갖게 해주었어요.
                  <br />
                  또 왕수리부엉이만의 신비한 힘도 나눠주었어요.
                  <br />
                  <br />
                  그렇게 모든 준비를 마친 오빌리들은 <br />
                  새로운 둥지를 찾아 <br />
                  모험을 떠나기 시작했답니다.
                </p>
              </div>
